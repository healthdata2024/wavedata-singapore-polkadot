...
export default function CreateSurveyModal({
    ...
    async function CreateSurveyHandle(e) {
        ...
        try {
            await sendTransaction(api,signerAddress, "CreateSurvey",[Number(Studyid),Cookies.get("userid"),name.value,description.value,d,image.value, Number(reward.value) * 1e18]);
